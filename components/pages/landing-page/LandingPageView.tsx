...
const LandingPageView = (props) => {
  return <LandingPageTemplate
    ...
    welcomeBaycode={
      <Card
        title={<>Be acknowledged of<span style={{color: "#0080e3ff"}}> threat</span></>}
    ...
    welcomeDevelopedApplicationsSecurity={
      <Card
        title={<>Code<span style={{color: "#0080e3ff"}}> Review</span></>}
    ...
    welcomeSoarSiem={
      <Card
        title={<>A Trusted<span style={{color: "#0080e3ff"}}> Service</span></>}
       ><>
          <p>Baycode Security offers cybersecurity services including SOAR (Security, Orchestration, Automation, and Response), which is a powerful tool that helps organizations automate and streamline their security processes. SOAR can improve a business' security posture and allow to respond more effectively to cyber threats by automating routine tasks and providing a centralized platform for managing security incidents. This can save time and resources, allowing security teams to focus on more critical tasks.</p><br/>
          ...
          <p>We expertise in cloud development and cloud security and can deliever secure, compliant cloud-based solutions, including those built on Microsoft Azure.</p><br/>
        </>
      </Card>
    }
/>}
