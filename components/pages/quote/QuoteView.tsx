            ...
            <div className={[styles.quoteView, ].join(' ')}>
                <div className={styles.quote}>
                    <div className={[styles.contactUs, styles.section].join(" ")}>
                        ...
                        <div>
                        <p>Feel free to use the contact form to reach me out instantly.</p><br/>
                        ...
                        <p>If the private key is lost, previous messages become unreadable, like an inaccessible crypto wallet. The communication through this unconventional form is very confidential.</p><br/>
                        <h3>Security Measures:</h3><br/>
                        <p>A breach of the cloud or Telegram account won't expose data. Attackers get only public key or mangled data, the private key is being stored safely offline. There is no confidential information stored on this website, nor accessible from cloud provider.</p><br/>
